...
private:	// 定数
	static constexpr float kSpeed = 0.1f;			// 回転速度
	static constexpr float kTargetH = 8.0f;		// ターゲットの座標から注視点までの高さ
	static constexpr float kStartTargetDir = 45.0f;	// ターゲットとの初期の距離
