...
VS_OUTPUT main(VS_INPUT VSInput)
{
    ...
    //重みづけ加算を行っている(8Frame用)
    lLocalWorldMatrix[0] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.x + 0] * VSInput.BlendWeight1.x;
    lLocalWorldMatrix[1] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.x + 1] * VSInput.BlendWeight1.x;
    lLocalWorldMatrix[2] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.x + 2] * VSInput.BlendWeight1.x;

    lLocalWorldMatrix[0] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.y + 0] * VSInput.BlendWeight1.y;
    lLocalWorldMatrix[1] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.y + 1] * VSInput.BlendWeight1.y;
    lLocalWorldMatrix[2] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.y + 2] * VSInput.BlendWeight1.y;

    lLocalWorldMatrix[0] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.z + 0] * VSInput.BlendWeight1.z;
    lLocalWorldMatrix[1] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.z + 1] * VSInput.BlendWeight1.z;
    lLocalWorldMatrix[2] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.z + 2] * VSInput.BlendWeight1.z;

    lLocalWorldMatrix[0] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.w + 0] * VSInput.BlendWeight1.w;
    lLocalWorldMatrix[1] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.w + 1] * VSInput.BlendWeight1.w;
    lLocalWorldMatrix[2] += g_LocalWorldMatrix.Matrix[ lBoneFloatIndex.w + 2] * VSInput.BlendWeight1.w;
