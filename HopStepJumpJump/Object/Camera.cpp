...
namespace
{
	...
	constexpr float kPrevCameraFollowSpeed = 1.0f - kCameraFollowSpeed;				// カメラが付いてくる初速度
	...
	constexpr float kStageClearTargetMoveTime = 600.0f;			// ステージクリア時のターゲットの移動時間
	constexpr float kStageClearEasingTime =  650.0f;			// ステージクリア時のイージングにかかる時間
}
