...
namespace
{
	...
	constexpr VECTOR kModelScale = { 0.8f,0.8f,0.8f };		// モデルスケール
	...
	const char* const kName = "Serpent";						// 名前
}

EnemySerpent::EnemySerpent(VECTOR pos)
{
	// 座標初期化
...
EnemySerpent::~EnemySerpent()
{
	/*処理無し*/
}

void EnemySerpent::Init()
{
	// モデル取得
