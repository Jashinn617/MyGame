...
namespace
{
	...
	constexpr float kRadius = 150.0f;						// 当たり判定半径
	constexpr float kHeight = 50.0f;						// 高さ
	constexpr float kRotSpeed = 9.0f;						// 回転速度
	constexpr VECTOR kModelScale = { 3.0f,3.0f,3.0f };		// モデルスケール
	constexpr float kSearchRadius = 400.0f;					// 索敵範囲の半径
	...
	const char* const kName = "Bug";						// 名前
}

EnemyBug::EnemyBug(VECTOR pos)
{
	// 座標初期化
