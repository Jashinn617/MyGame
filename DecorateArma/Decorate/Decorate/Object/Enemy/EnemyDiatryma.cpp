...
namespace
{
	...
	constexpr VECTOR kModelScale = { 1.2f,1.2f,1.2f };		// モデルスケール
	...
	const char* const kName = "Diatryma";					// 名前
}

EnemyDiatryma::EnemyDiatryma(VECTOR pos)
{
	// 座標初期化
...
EnemyDiatryma::~EnemyDiatryma()
{
	/*処理無し*/
}

void EnemyDiatryma::Init()
{
	// モデル取得
